...
struct ltEdge {
    bool operator()(const Edge &e1, const Edge &e2) const {
        ...
        if (e1.first == e2.first && e1.second.id < e2.second.id) return true;
        if (e1.first == e2.first && e1.second.id == e2.second.id && e1.second.weight < e2.second.weight) return true;
        if (e1.first == e2.first && e1.second.id == e2.second.id && e1.second.weight == e2.second.weight &&
